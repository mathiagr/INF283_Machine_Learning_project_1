...
class mlp2:
    ...
    def __init__(self,inputs,targets,nhidden,beta=1,momentum=0.9,outtype='logistic'):
        ...
        # Initialise network
        self.weights1 = (np.random.rand(self.nin+1,self.nhidden+1)-0.5)*2/np.sqrt(self.nin)
        self.weights2 = (np.random.rand(self.nhidden+1,self.nhidden+1)-0.5)*2/np.sqrt(self.nhidden)
        #2.nd hidden layer
...
#Concatenate (bias node adder en kolonne). Dette tuller til dimensjonene når vi har 2 skjulte lav. Fjerner bias?
#Trance work deep work.
...
#       concatenate legger til en kolonne med 1'ere. da blir dimensjonen 27 ikke 26
